    ...
    private function openPlayWeights(PitchZone $zone): array
    {
        return match($zone) {
            ...
            PitchZone::AttackingThird => [
                MatchEventType::PassCompleted->value  => 0.34,
                ...
                MatchEventType::TackleWon->value      => 0.06,
                MatchEventType::ShotAttempt->value    => 0.20,
            ],
            PitchZone::PenaltyArea => [
                MatchEventType::PassCompleted->value  => 0.22,
                MatchEventType::PassFailed->value     => 0.07,
                MatchEventType::DribbleSuccess->value => 0.05,
                MatchEventType::DribbleFailed->value  => 0.04,
                MatchEventType::FoulCommitted->value  => 0.04,
                MatchEventType::Interception->value   => 0.06,
                MatchEventType::TackleWon->value      => 0.08,
                MatchEventType::ShotAttempt->value    => 0.40,
            ],
        };
    }
